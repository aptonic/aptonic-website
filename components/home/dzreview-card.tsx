export default function DzReviewCard({
  children,
  name,
  src,
}: {
  ...
  return (
    <div className="flex justify-center ml-8 mr-8">
        ...
        <div className="m-4 ml-0 mr-0 block rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-800 dark:shadow-black/20">
          <div className="md:flex md:flex-row">
            <div className="md:ml-6">
              ...
              <p className="mb-2 text-base font-semibold text-neutral-800 dark:text-neutral-200">
                {name}
              </p>
              <p className="mb-0 text-sm font-semibold text-neutral-500 dark:text-neutral-400">
                {src}
              </p>
            </div>
          </div>
