...
export default function Page() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await fetch(
        "https://licensing.aptonic.com/send_lost_license",
        {
          method: "POST",
  ...
  return (
      <div className="z-10 mt-28 px-5 sm:w-full md:w-1/3">
        <h2 className="mb-5 text-xl">Dropzone 4 Pro Lost Serial</h2>

        <div className="mt-10 text-gray-700">
          <p>
            Put your email address in the field below and we will send you an
            email with your Dropzone 4 Pro Lifetime serial number.
          </p>
